...
export default function Cart() {
  ...
  return (
    <div>
      <IconBtn className={`${isOpen ? `dark:bg-gray-900 rounded-es-none rounded-ee-none dark:hover:bg-gray-900` : ``}`} onClick={() => setIsOpen(!isOpen)}>
      ...
      <div className="relative">
        ...
        dark:bg-gray-900`}
        >
          <ProductCartCard product={{ id: 1, price: 100, name: "test", imageUrl: null }} quantity={3} />
          <ProductCartCard product={{ id: 1, price: 100, name: "test", imageUrl: null }} quantity={3} />
          <ProductCartCard product={{ id: 1, price: 100, name: "test", imageUrl: null }} quantity={3} />
        </div>
      </div>
