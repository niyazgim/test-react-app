...
const ProductImage = ({ imageUrl, altText }: Props) => {
  ...
  return (
    <div className="w-full aspect-square">
      {!imageError && imageUrl ? (
        <>
          {imageLoading && <div className="w-full h-full flex flex-col gap-5 items-center justify-center"><div className="lds-ring"><div></div><div></div><div></div><div></div></div></div>}
          <img
        ...
        <div className="w-full h-full border border-gray-900 rounded flex flex-col gap-5 items-center justify-center">
          <svg className="h-16" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
